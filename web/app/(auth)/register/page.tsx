      ...
      <div className="w-full max-w-md animate-fade-in">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-surface-500 dark:text-surface-400">
            Join EchoNet and start sharing your ideas
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-surface-200 bg-white p-8 shadow-sm dark:border-surface-800 dark:bg-surface-900">
          ...
          {success && (
            <div className="mb-6 rounded-xl border border-green-200 bg-green-50 p-4 text-sm font-medium text-green-700 dark:border-green-900/50 dark:bg-green-950/50 dark:text-green-400">
              <div className="flex items-center gap-2">
                <svg
                  className="h-4 w-4 flex-shrink-0"
                  fill="none"
